...
function showImage(image) {
    $(image).toggleClass('list-image-show');
    if ($(image).hasClass('list-image-show')) {
        const src = image.src;
...
function openUserInfo() {
    window.open('userinfo?id=' + window.sessionStorage.getItem('id'))
}
...
function signOut() {
    ...
    window.sessionStorage.setItem('flag', 'home');
    $.get('/login/sign_out', {name: window.sessionStorage.getItem('name'), key: window.sessionStorage.getItem('key')})
}
